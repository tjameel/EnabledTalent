            ...
            <div className="w-full bg-white/90 backdrop-blur-md rounded-[50px] p-12 md:p-20 shadow-xl border border-white/60">
               ...
               <div className="grid lg:grid-cols-2 gap-16 mb-16">
                  <div className="max-w-full lg:max-w-[500px]">
                     <h2 className="text-2xl sm:text-3xl lg:text-[40px] lg:leading-[52px]" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 700, color: '#000000', marginBottom: '24px', lineHeight: '1.3' }}>
                        Building Infrastructure<br className="hidden sm:block" />
                        <span className="sm:hidden"> </span><span className="lg:whitespace-nowrap">for meaningful employment</span>
                     </h2>
