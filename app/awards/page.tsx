  ...
  return (
    <div className="min-h-screen w-full flex flex-col bg-[#fffbf0] text-gray-900 font-sans overflow-x-hidden">
      ...
      <main className="flex-grow w-full">
        ...
        {/* --- CATEGORIES SECTION --- */}
        <section id="categories" className="py-16 md:py-24 px-6 bg-[#fffbf0] w-full">
           <div className="container mx-auto max-w-7xl">
             <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                {awardCategories.map((cat, i) => (
                   <div key={i} className="flex flex-col items-start p-6 md:p-8 bg-white rounded-3xl border-2 border-transparent hover:border-[#F36D21] hover:shadow-xl transition-all duration-300">
                      ...
                      <h3 className="text-xl md:text-2xl font-bold text-black mb-4 leading-tight">{cat.title}</h3>
                      <p className="text-gray-500 text-sm md:text-base leading-relaxed">{cat.desc}</p>
                   </div>
                ))}
             </div>
           </div>
        ...
        <section className="py-16 md:py-24 px-6 bg-[#fffbf0] w-full">
           <div className="container mx-auto max-w-6xl grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
             ...
             <div className="order-1 lg:order-2 text-center lg:text-left">
                <h2 className="text-3xl md:text-4xl text-black mb-6">Why It <span className="text-[#F36D21]">Matters?</span></h2>
                <p className="text-base md:text-lg text-gray-600 mb-6 leading-relaxed">Every nomination tells a story of progress — of employers who open doors, educators empowering individuals, and people proving that talent has no limits.</p>
                <p className="text-base md:text-lg text-gray-600 leading-relaxed">By recognizing these achievements, we're building momentum toward a more inclusive, accessible future of work.</p>
             </div>
           </div>
        </section>
