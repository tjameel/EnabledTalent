...
export default function ComingSoonPage() {
  ...
  const pageTitle = "AI Career Coach"; 
  const pageDesc = "Personalized career guidance, anytime you need it. From resume optimization to real-time interview practice, our AI Career Coach provides specific feedback to help you build confidence and land your dream job.";
