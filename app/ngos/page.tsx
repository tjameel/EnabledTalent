...
export default function ComingSoonPage() {
  ...
  const pageTitle = "NGO Partnerships"; 
  const pageDesc = "Empowering communities together. We work alongside non-profits to provide digital resources, training programs, and direct employment pathways for the individuals you support, amplifying your impact.";
  return (
